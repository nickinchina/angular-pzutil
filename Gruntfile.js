...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        meta: {
            modules: 'angular.module("pzutil", [<%= srcModules %>]);',
            tplmodules: 'angular.module("pzutil.tpls", [<%= tplModules %>]);',
            all: 'angular.module("pzutil", ["pzutil.tpls", <%= srcModules %>]);',
            banner: ['/*',
                ' * <%= pkg.name %>',
                ' * <%= pkg.homepage %>\n',
    ...
    //Common pzutil module containing all modules for src and templates
    ...
    function findModule(name) {
        ...
        var module = {
            name: name,
            moduleName: enquote('pzutil.' + name),
        ...
        grunt.file.expand('src/' + name + '/*.js')
            ...
            .forEach(function(contents) {
                ...
                dependencies.split(',').forEach(function(dep) {
                    if (dep.indexOf('pzutil.') > -1) {
                        var depName = dep.trim().replace('pzutil.','').replace(/['"]/g,'');
