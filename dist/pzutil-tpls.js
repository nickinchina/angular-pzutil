...
angular.module("template/simplegrid/header.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/simplegrid/header.html",
    ...
    "        <i class=\"fa fa-long-arrow-down pull-right\" ng-show=\"col.sortOrder\"></i>\n" +
    "        <i class=\"fa fa-long-arrow-up pull-right\" ng-show=\"!col.sortOrder && col.sortOrder!=undefined\"></i>\n" +
    "    </div>\n" +
    "</div>");
}]);
